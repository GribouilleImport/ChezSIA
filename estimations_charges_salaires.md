...
### La Réduction Générale (ex-réduction Fillon)

C'est **LA principale aide** pour les salaires, et son impact est implicitement inclus dans le budget. C'est elle qui explique pourquoi le coût total pour l'employeur n'est pas simplement "le salaire net multiplié par deux". Elle diminue de manière significative les charges patronales sur les salaires proches du SMIC.

### L'ACRE (Aide à la Création ou à la Reprise d'une Entreprise)

Rappel : c'est une aide pour vous en tant que créateur, pas pour vos salariés. Pour plus de détails, consultez le fichier `details_aide_acre.md`.
