...
- [2. Architecture & Outils](#2-architecture-outils)
  ...
  - [2.2. Documentation Agent (`.dev/agents/documentation/agent.py`)](#22-documentation-agent-devagentsdocumentationagentpy)
- [3. Conventions Visuelles](#3-conventions-visuelles)
  - [3.1. Emojis Suggérés](#31-emojis-suggeres)
