...
│   │   ├─ 1) ------     [Salaires : Employé](Annexes/estimation_charges_salaires.md#1-salaires--employé-1700-net)<br>
...
│   │   ├─ 2) ------     [Salaires : Employé](Annexes/estimation_charges_salaires.md#2-salaires--employé-1500-net)<br>
...
│   │   └─ 3) ------     [Salaires : Dirigeant](Annexes/estimation_charges_salaires.md#3-salaires--dirigeant-1500-net)<br>
...
│       └ 13) ----   [Règle d’or à retenir](Sources/20251223_echange_alicia.md#13-règle-dor-à-retenir)<br>
│<br>
└ 📁 [.dev/](.dev/README.md)<br>
    ...
    │       │   ├─ 2.1. --   [Orchestrateur (`.dev/agents/orchestrator/main.py`)](.dev/agents/AGENTS.md#21-orchestrateur-devagentsorchestratormainpy)<br>
    │       │   └─ 2.2. --   [Documentation Agent (`.dev/agents/documentation/agent.py`)](.dev/agents/AGENTS.md#22-documentation-agent-devagentsdocumentationagentpy)<br>
    │       ├─ 3. ----   [Conventions Visuelles](.dev/agents/AGENTS.md#3-conventions-visuelles)<br>
    │       │   └─ 3.1. --   [Emojis Suggérés](.dev/agents/AGENTS.md#31-emojis-suggérés)<br>
    │       └─ 4. ----   [Organisation des Dossiers](.dev/agents/AGENTS.md#4-organisation-des-dossiers)<br>
    │<br>
